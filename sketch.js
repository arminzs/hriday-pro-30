...
/*
  ...
  box6 = new YellowBox(500,360,20,30);
  ...
  spring = new  projectile(ball.body,{x:200,y:50});
  ground= new  platform1(550,380,250,20);
  groundHouvering = new platform1(550,160,200,20);
